...
// Fetch feedback data
$sql = "SELECT id, first_name, last_name, email, phone, services, `message`, created_at FROM contact_us ORDER BY created_at DESC";
...
<head>
    ...
    <title>Contact_Us Report Report</title>
    <style>
        body {
